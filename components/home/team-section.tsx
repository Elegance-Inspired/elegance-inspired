    ...
    <section className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4 sm:px-10 lg:px-12 xl:px-14">
        <div className="text-center mb-16">
          ...
          >
            <span className="text-secondary">Our Dedicated Team:</span> Your Trusted Partners in Branding
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="mt-12 text-center">
          <Link href="/about#creative-team" className="text-primary hover:text-primary/80 font-medium">
